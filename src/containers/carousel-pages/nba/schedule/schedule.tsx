...
export interface NBAScheduleScreenProps {
  navigation?: any
...
export interface NBAScheduleScreenState {
  isRefreshing: boolean
  selectedDate: string
  dayList: Array<string>
}

class NBASchedule extends React.Component<NBAScheduleScreenProps, NBAScheduleScreenState> {
  ...
  componentWillReceiveProps(nextProps: NBAScheduleScreenProps) {
  ...
  render() {
    const { isLoadingStart, nbaScheduleStatus, nbaScheduleData, nbaSummaryStatus } = this.props
    ...
    return (
      <View style={screenStyles.ROOT}>
        ...
        <LoadingView isVisible={!isRefreshing && (!isLoadingStart || nbaScheduleStatus === 'pending')} />
      </View>
    )
  }
}
